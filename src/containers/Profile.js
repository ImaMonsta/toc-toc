                    ...
                    <div className="container">
                        <div className="breadcrumb-info text-center">
                            <div className="user-image">
                                <img src="/images/others/author.png" alt="author" className="img-responsive" />
                            </div>
                            ...
                            <ul className="job-meta tr-list list-inline">
                                ...
                                <li><i className="fa fa-envelope" aria-hidden="true"></i><a href="">jhondoe@gmail.com</a></li>
                                <li><i className="fa fa-briefcase" aria-hidden="true"></i>UI & UX Designer</li>
                            </ul>
                            ...
                            <div className="col-sm-4 col-md-3">
                                <div className="tr-sidebar">
                                    <ul className="nav nav-tabs profile-tabs section" role="tablist">
                                        ...
                                        <li role="presentation"><a href="#resume" aria-controls="resume" role="tab" data-toggle="tab"><span><i className="fa fa-user-o" aria-hidden="true"></i></span> My Resume</a></li>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-sm-6 col-md-4">
                                                                    ...
                                                                    <div className="calendar">
                                                                        <input type="date" className="form-control" value="2015-01-15"/>
                                                                    </div>{/*<!-- calendar -->*/}
                                                                </div>
                                                                <div className="col-sm-6 col-md-4">
                                                                    <label>To</label>
                                                                    <div className="calendar">
                                                                        <input type="date" className="form-control" value="2016-01-13"/>
                                                                    </div>{/*<!-- calendar -->*/}
                                                                </div>
                                                        ...
                                                        <div className="code-edit-small">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-sm-6 col-md-4">
                                                                    ...
                                                                    <div className="calendar">
                                                                        <input type="date" className="form-control" value="2012-01-01"/>
                                                                    </div>{/*<!-- calendar -->*/}
                                                                </div>
                                                                <div className="col-sm-6 col-md-4">
                                                                    <label>To Year (or expected)</label>
                                                                    <div className="calendar">
                                                                        <input type="date" className="form-control" value="2017-01-13"/>
                                                                    </div>{/*<!-- calendar -->*/}
                                                                </div>
                                                                <div className="col-sm-6 col-md-4">
                                            ...
                                            <li className="personal-deatils code-edit-small">
                                                ...
                                                <div className="media-body">
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-8">
                                                            <div className="calendar">
                                                                <input type="date" className="form-control" value="1982-01-26"/>
                                                            </div>{/*<!-- calendar -->*/}
                                                        </div>
                                                    </div>	
                                                    <div className="row">
