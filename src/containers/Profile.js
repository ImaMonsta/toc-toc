                            ...
                            <div className="col-sm-4 col-md-3">
                                <div className="tr-sidebar">
                                    <ul className="nav nav-tabs profile-tabs section" role="tablist">
                                        ...
                                        {profile && profile.isCandidate && <li role="presentation" className={ appcontrol.optionMenuCandidate === 2 ? 'active' : ''}><a onClick={e => optionMenuEditCandidate(2)} aria-controls="resume" role="tab" data-toggle="tab"><span><i className="fa fa-user-o" aria-hidden="true"></i></span> My Resume</a></li>}
                                        {profile && profile.isCandidate && <li role="presentation" className={ appcontrol.optionMenuCandidate === 3 ? 'active' : ''}><a onClick={e => optionMenuEditCandidate(3)} aria-controls="edit-resume" role="tab" data-toggle="tab"><span><i className="fa fa-pencil-square-o" aria-hidden="true"></i></span> Edit Resume</a></li>}
                                        {profile && profile.isCandidate && <li role="presentation" className={ appcontrol.optionMenuCandidate === 4 ? 'active' : ''}><a onClick={e => optionMenuEditCandidate(4)} aria-controls="questionary" role="tab" data-toggle="tab"><span><i className="fa fa-question-circle" aria-hidden="true"></i></span> Questionary <span className="badge">1</span></a></li>}
